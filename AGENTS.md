...
- **Notes:** The domain layer is to be implemented in Supabase edge functions. Deployment will be done using CloudFlare. We'll use pnpm instead of npm where possible.
